<?php
/**
 * Team 4 Images (Dark version)
 *
 * @package aino
 */

return array(
	'title'      => __( 'Four team images with large heading and intro text (Dark)', 'aino' ),
	...
	<figure class="wp-block-image size-full"><img src="' . get_stylesheet_directory_uri() . '/assets/images/pattern-lib/team-four-img-04-dark.jpg" alt=""/></figure>
	<!-- /wp:image -->
	...
	<figure class="wp-block-image size-full"><img src="' . get_stylesheet_directory_uri() . '/assets/images/pattern-lib/team-four-img-02-dark.jpg" alt=""/></figure>
	<!-- /wp:image -->
	...
	<figure class="wp-block-image size-full"><img src="' . get_stylesheet_directory_uri() . '/assets/images/pattern-lib/team-four-img-01-dark.jpg" alt=""/></figure>
	<!-- /wp:image -->
	...
	<figure class="wp-block-image size-full"><img src="' . get_stylesheet_directory_uri() . '/assets/images/pattern-lib/team-four-img-03-dark.jpg" alt=""/></figure>
	<!-- /wp:image -->
