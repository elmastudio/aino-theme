...
return array(
	...
	<p class="has-variant-font-secondary-color has-text-color">We are a small creative team from Portland, Oregon. Our clients value that we create individual software solutions tailored to their needs.</p>
	<!-- /wp:paragraph --></div>
	...
	<div class="wp-block-ainoblocks-grid-item col_start_d__1 col_end_d__7 col_start_t__1 col_end_t__7 col_start_m__3 col_end_m__11 align-self__stretch justify-self__stretch no-stacking mb_t__0"><!-- wp:image {"sizeSlug":"full","linkDestination":"none","borderRadius":"xs"} -->
