...
return array(
	...
	<div class="wp-block-ainoblocks-grid-item col_start_d__1 col_end_d__4 col_start_t__1 col_end_t__13 col_start_m__1 col_end_m__13 align-self__start justify-self__stretch no-stacking mb_t__11 mb_m__0 two-col-grid-tablet"><!-- wp:heading {"textColor":"variant-font-primary","fontSize":"xxs","paddingBottom":7} -->
	...
	<figure class="wp-block-image size-full"><img src="' . get_stylesheet_directory_uri() . '/assets/images/pattern-lib/portfolio-four-img-01-dark.jpg" alt=""/></figure>
	<!-- /wp:image --></div>
	<!-- /wp:ainoblocks/grid-item -->
	...
	<figure class="wp-block-image size-full"><img src="' . get_stylesheet_directory_uri() . '/assets/images/pattern-lib/portfolio-four-img-02-dark.jpg" alt=""/></figure>
	<!-- /wp:image --></div>
	<!-- /wp:ainoblocks/grid-item -->
	...
	<figure class="wp-block-image size-full pt__10"><img src="' . get_stylesheet_directory_uri() . '/assets/images/pattern-lib/portfolio-four-img-03-dark.jpg" alt=""/></figure>
	<!-- /wp:image --></div>
	<!-- /wp:ainoblocks/grid-item -->
	...
	<figure class="wp-block-image size-full pt__10"><img src="' . get_stylesheet_directory_uri() . '/assets/images/pattern-lib/portfolio-four-img-04-dark.jpg" alt=""/></figure>
	<!-- /wp:image --></div>
