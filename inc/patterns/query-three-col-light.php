...
return array(
	...
	'content'    => '<!-- wp:group {"align":"full","backgroundColor":"background-primary","paddingTop":15,"paddingBottom":14} -->
	<div class="wp-block-group alignfull has-background-primary-background-color has-background pt__15 pb__14"><!-- wp:ainoblocks/grid-container {"paddingTop":0} -->
	...
	<div class="wp-block-ainoblocks-grid-item col_start_d__1 col_end_d__13 col_start_t__1 col_end_t__13 col_start_m__1 col_end_m__13 align-self__start justify-self__start no-stacking mb_m__0"><!-- wp:heading {"textColor":"font-primary","fontSize":"xxs","paddingBottom":13} -->
	<h2 class="has-font-primary-color has-text-color has-xxs-font-size pb__13">From the blog</h2>
	<!-- /wp:heading --></div>
