...
return array(
	...
	<div class="wp-block-ainoblocks-grid-item col_start_d__2 col_end_d__12 col_start_t__1 col_end_t__13 col_start_m__1 col_end_m__13 align-self__start justify-self__start no-stacking mt_d__0 mt_m__0 mb_d__0 mb_m__0 pb__14"><!-- wp:heading {"textColor":"variant-font-primary","fontSize":"xl"} -->
	<h2 class="has-variant-font-primary-color has-text-color has-xl-font-size">All the ways to get in touch with us</h2>
	<!-- /wp:heading --></div>
	<!-- /wp:ainoblocks/grid-item -->
	...
	<div class="wp-block-ainoblocks-grid-item col_start_d__8 col_end_d__10 col_start_t__7 col_end_t__10 col_start_m__1 col_end_m__13 align-self__start justify-self__start no-stacking mt_d__0 mb_d__0 mb_m__0"><!-- wp:paragraph {"textColor":"variant-font-secondary","fontSize":"m"} -->
	<p class="has-variant-font-secondary-color has-text-color has-m-font-size"><meta charset="utf-8"><meta charset="utf-8"><strong>Auckland Office</strong><br>14/5 Kauri Avenue<br>0112 Auckland<br>New Zealand<br>+44 33 505050</p>
	<!-- /wp:paragraph -->
	...
	<div class="wp-block-ainoblocks-grid-item col_start_d__10 col_end_d__12 col_start_t__10 col_end_t__13 col_start_m__1 col_end_m__13 align-self__start justify-self__start no-stacking mt_d__0 mt_t__0 mt_m__7 mb_d__0 mb_m__0"><!-- wp:paragraph {"textColor":"variant-font-secondary","fontSize":"m"} -->
	<p class="has-variant-font-secondary-color has-text-color has-m-font-size"><strong>Auckland Office</strong><br>14/5 Kauri Avenue<br>0112 Auckland<br>New Zealand</p>
	<!-- /wp:paragraph -->
