...
return array(
	...
	'content'    => '<!-- wp:group {"className":"alignfull","backgroundColor":"variant-background-primary","paddingBottom":0} -->
	<div class="wp-block-group alignfull has-variant-background-primary-background-color has-background"><!-- wp:ainoblocks/grid-container {"paddingTop":13} -->
	...
	<div class="wp-block-ainoblocks-grid-item col_start_d__2 col_end_d__12 col_start_t__2 col_end_t__12 col_start_m__1 col_end_m__13 align-self__start justify-self__center no-stacking mb_t__0 mb_m__0"><!-- wp:heading {"level":2,"textAlign":"center","textColor":"variant-font-primary","fontSize":"xl","paddingBottom":0} -->
	...
	<div class="wp-block-ainoblocks-grid-item col_start_d__5 col_end_d__9 col_start_t__4 col_end_t__10 col_start_m__2 col_end_m__12 align-self__start justify-self__center no-stacking mb_t__0 mb_m__0"><!-- wp:paragraph {"textColor":"variant-font-secondary","align":"center","paddingTop":6} -->
	<p class="has-variant-font-secondary-color has-text-color has-text-align-center pt__6">Let&#8217;s start to build innovative websites that stand out from the crowd.</p>
	<!-- /wp:paragraph --></div>
	<!-- /wp:ainoblocks/grid-item -->
	...
	<div class="wp-block-ainoblocks-multiple-buttons aligncenter pt__7 pb__11"><div class="wp-block-ainoblocks-multiple-buttons__inner"><!-- wp:ainoblocks/button {"borderRadius":200,"backgroundColor":"#777b7d","textColor":"#ffffff","label":"Get started"} -->
	<div class="wp-block-ainoblocks-button" style="border-radius:200px"><a class="wp-block-ainoblocks-button__link size__m 200 has-custom-background has-custom-text-color" style="background-color:#777b7d;color:#ffffff;border-radius:200px">Get started</a></div>
	...
	<!-- wp:group {"className":"alignfull","backgroundColor":"primary-background","paddingBottom":17} -->
	<div class="wp-block-group alignfull has-primary-background-background-color has-background pb__17"><!-- wp:ainoblocks/grid-container -->
	...
	<figure class="wp-block-image size-large"><img src="' . get_stylesheet_directory_uri() . '/assets/images/pattern-lib/hero-01-dark.jpg" alt=""/></figure>
	<!-- /wp:image --></div>
	<!-- /wp:ainoblocks/grid-item --></div></div>
	<!-- /wp:ainoblocks/grid-container --></div>
	<!-- /wp:group -->',
