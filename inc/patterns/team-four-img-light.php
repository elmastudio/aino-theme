...
return array(
	...
	<figure class="wp-block-image size-full"><img src="' . get_stylesheet_directory_uri() . '/assets/images/pattern-lib/team-four-img-01.jpeg" alt=""/></figure>
	<!-- /wp:image -->
	...
	<figure class="wp-block-image size-full"><img src="' . get_stylesheet_directory_uri() . '/assets/images/pattern-lib/team-four-img-02.jpeg" alt=""/></figure>
	<!-- /wp:image -->
	...
	<figure class="wp-block-image size-full"><img src="' . get_stylesheet_directory_uri() . '/assets/images/pattern-lib/team-four-img-04.jpeg" alt=""/></figure>
	<!-- /wp:image -->
