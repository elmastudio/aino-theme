...
return array(
	...
	<div class="wp-block-ainoblocks-grid-item col_start_d__5 col_end_d__8 col_start_t__3 col_end_t__7 col_start_m__1 col_end_m__13 align-self__start justify-self__stretch no-stacking mt_d__0 mb_d__0 mb_m__10"><!-- wp:navigation {"orientation":"vertical","textColor":"variant-font-secondary","fontSize":"text-xl"} -->
	...
	<div class="wp-block-ainoblocks-grid-item col_start_d__8 col_end_d__10 col_start_t__7 col_end_t__10 col_start_m__1 col_end_m__13 align-self__start justify-self__start no-stacking mt_d__0 mb_d__0 mb_m__0"><!-- wp:paragraph {"textColor":"variant-font-secondary","fontSize":"text-s"} -->
	<p class="has-variant-font-secondary-color has-text-color has-text-s-font-size"><meta charset="utf-8"><meta charset="utf-8"><strong>Auckland Office</strong><br>14/5 Kauri Avenue<br>0112 Auckland<br>New Zealand<br>+44 33 505050</p>
	<!-- /wp:paragraph -->
	
	<!-- wp:paragraph {"textColor":"variant-font-secondary","paddingTop":11} -->
	<p class="has-variant-font-secondary-color has-text-color pt__11"><meta charset="utf-8"><strong>Wellington Office</strong><br>120 Wallis Street<br>0124 Wellington<br>New Zealand<br><meta charset="utf-8">+44 33 505050</p>
	<!-- /wp:paragraph --></div>
	<!-- /wp:ainoblocks/grid-item -->
	...
	<div class="wp-block-ainoblocks-grid-item col_start_d__10 col_end_d__12 col_start_t__10 col_end_t__13 col_start_m__1 col_end_m__13 align-self__start justify-self__start no-stacking mt_d__0 mt_t__0 mt_m__7 mb_d__0 mb_m__0"><!-- wp:paragraph {"textColor":"variant-font-secondary","fontSize":"text-s"} -->
	<p class="has-variant-font-secondary-color has-text-color has-text-s-font-size"><strong>Auckland Office</strong><br>14/5 Kauri Avenue<br>0112 Auckland<br>New Zealand</p>
	<!-- /wp:paragraph -->
	
	<!-- wp:paragraph {"textColor":"variant-font-secondary","fontSize":"text-s","paddingTop":11} -->
	<p class="has-variant-font-secondary-color has-text-color has-text-s-font-size pt__11"><strong>Write us a note</strong><br>We always love to hear from you<strong><br></strong></p>
	<!-- /wp:paragraph -->
