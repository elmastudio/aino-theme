...
return array(
	...
	<div class="wp-block-ainoblocks-grid-item col_start_d__1 col_end_d__5 col_start_t__1 col_end_t__5 col_start_m__1 col_end_m__13 align-self__start justify-self__stretch no-stacking"><!-- wp:heading {"textAlign":"left","textColor":"variant-font-primary","fontSize":"text-l"} -->
	<h2 class="has-text-align-left has-variant-font-primary-color has-text-color has-text-l-font-size">WordPress is evolving</h2>
	<!-- /wp:heading --></div>
