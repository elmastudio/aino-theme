...
return array(
	...
	<h2 class="has-button-color-secondary-color has-text-color has-xxs-font-size pb__7">Packaging Design</h2>
	<!-- /wp:heading -->
	
	<!-- wp:paragraph {"textColor":"font-secondary","fontSize":"xs","paddingTop":0} -->
	<p class="has-font-secondary-color has-text-color has-xs-font-size">We had the pleasure to design the new packaging of Wallis cookies, a famous New Zealand vegan dog cookies brand.</p>
	<!-- /wp:paragraph --></div>
	...
	<figure class="wp-block-image size-full"><img src="' . get_stylesheet_directory_uri() . '/assets/images/pattern-lib/portfolio-four-img-01.jpg" alt=""/></figure>
	<!-- /wp:image --></div>
	<!-- /wp:ainoblocks/grid-item -->
	...
	<figure class="wp-block-image size-full"><img src="' . get_stylesheet_directory_uri() . '/assets/images/pattern-lib/portfolio-four-img-02.jpg" alt=""/></figure>
	<!-- /wp:image --></div>
	<!-- /wp:ainoblocks/grid-item -->
	...
	<figure class="wp-block-image size-full pt__10"><img src="' . get_stylesheet_directory_uri() . '/assets/images/pattern-lib/portfolio-four-img-03.jpg" alt=""/></figure>
	<!-- /wp:image --></div>
	<!-- /wp:ainoblocks/grid-item -->
	...
	<figure class="wp-block-image size-full pt__10"><img src="' . get_stylesheet_directory_uri() . '/assets/images/pattern-lib/portfolio-four-img-04.jpg" alt=""/></figure>
	<!-- /wp:image --></div>
