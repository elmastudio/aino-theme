...
return array(
	...
	'content'    => '<!-- wp:group {"backgroundColor":"variant-background-primary","className":"site-header header-dark"} --><div class="wp-block-group site-header header-dark has-variant-background-primary-background-color has-background"><!-- wp:group {"className":"header-content"} --><div class="wp-block-group header-content"><!-- wp:site-title {"fontSize":"xxxs","textColor":"variant-font-secondary"} /-->
