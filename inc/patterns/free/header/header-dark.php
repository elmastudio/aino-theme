...
return array(
	...
	'content'    => '<!-- wp:group {"backgroundColor":"variant-background-primary","className":"site-header header-dark"} --><div class="wp-block-group site-header header-dark has-variant-background-primary-background-color has-background"><!-- wp:group {"className":"header-content,"paddingTop":5"} --><div class="wp-block-group header-content pt__5"><!-- wp:site-title {"fontSize":"text-l","textColor":"variant-font-secondary"} /-->
	...
	<!-- wp:navigation {"textColor":"variant-font-primary","layout":{"type":"flex","setCascadingProperties":true,"justifyContent":"right"},"fontSize":"text-s","style":{"spacing":{"blockGap":"1.5rem"}}} -->
