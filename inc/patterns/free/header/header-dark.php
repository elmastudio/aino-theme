...
return array(
	...
	<!-- wp:navigation {"textColor":"variant-font-primary","layout":{"type":"flex","setCascadingProperties":true,"justifyContent":"left"},"fontSize":"text-s","style":{"spacing":{"blockGap":"1.5rem"}}} -->
