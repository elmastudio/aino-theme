...
return array(
	...
	<div class="wp-block-ainoblocks-grid-item col_start_d__1 col_end_d__6 col_start_t__1 col_end_t__6 col_start_m__1 col_end_m__13 align-self__start justify-self__start no-stacking mb_t__0 mb_m__7"><!-- wp:heading {"level":2,"textColor":"variant-font-primary","fontSize":"m"} -->
	<h2 class="has-variant-font-primary-color has-text-color has-m-font-size">Our story</h2>
	<!-- /wp:heading --></div>
	...
	<div class="wp-block-ainoblocks-grid-item col_start_d__6 col_end_d__13 col_start_t__6 col_end_t__13 col_start_m__1 col_end_m__13 align-self__start justify-self__start no-stacking"><!-- wp:paragraph {"textColor":"variant-font-secondary","fontSize":"m","paddingBottom":11} -->
