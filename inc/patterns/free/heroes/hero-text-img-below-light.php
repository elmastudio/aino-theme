...
return array(
	...
	'content'    => '<!-- wp:group {"align":"full","backgroundColor":"background-primary","className":"fullwidth"} -->
	<div class="wp-block-group alignfull fullwidth has-background-primary-background-color has-background"><!-- wp:ainoblocks/grid-container {"paddingTop":15} -->
	...
	<div class="wp-block-ainoblocks-grid-item col_start_d__2 col_end_d__12 col_start_t__2 col_end_t__12 col_start_m__1 col_end_m__13 align-self__start justify-self__center no-stacking mb_t__0 mb_m__0"><!-- wp:heading {"level":2,"textAlign":"center","textColor":"font-primary","fontSize":"text-7-xl","paddingBottom":0} -->
	<h2 class="has-text-align-center has-font-primary-color has-text-color has-text-7-xl-font-size">Design Ideas<br>for WordPress</h2>
	<!-- /wp:heading --></div>
	...
	<div class="wp-block-ainoblocks-multiple-buttons aligncenter pt__7 pb__11"><!-- wp:ainoblocks/button {"size":"size__l","borderRadius":200,"label":"Get started","backgroundColor":"primary","textColor":"button-color-primary","className":"is-style-primary"} -->
	<div class="wp-block-ainoblocks-button is-style-primary has-button-color-primary-color has-primary-background-color has-text-color has-background" style="border-radius:200px"><a class="wp-block-ainoblocks-button__link size__l 200" style="border-radius:200px">Get started</a></div>
