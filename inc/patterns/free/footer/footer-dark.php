...
return array(
	...
	'content'    => '<!-- wp:group {"backgroundColor":"variant-background-secondary","className":"site-footer","paddingTop":10,"paddingBottom":10} -->
	...
	<div class="wp-block-ainoblocks-grid-item col_start_d__2 col_end_d__12 col_start_t__1 col_end_t__13 col_start_m__1 col_end_m__13 align-self__center justify-self__stretch no-stacking mt_d__0 center"><!-- wp:paragraph {"align":"center","textColor":"variant-font-secondary","fontSize":"text-xxs"} --><p class="has-text-align-center has-variant-font-secondary-color has-text-color has-text-xxs-font-size">© 2022 </p><!-- /wp:paragraph --><!-- wp:site-title {"level":0,"style":{"typography":{"fontStyle":"normal","fontWeight":"700"}},"fontSize":"text-xxs","textColor":"variant-font-secondary"} /--><!-- wp:paragraph {"align":"center","textColor":"variant-font-secondary","fontSize":"text-xxs"} --><p class="has-text-align-center has-variant-font-secondary-color has-text-color has-text-xxs-font-size"> Built with <a rel="nofollow" href="https://ainoblocks.io/">AinoBlocks</a>.</p>
	<!-- /wp:paragraph --></div>
