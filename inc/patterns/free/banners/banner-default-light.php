...
return array(
	...
	<div class="wp-block-ainoblocks-flex-item auto pt__9 pb__9 pl__8 pr__8" style="flex-grow:2"><!-- wp:paragraph {"textColor":"font-secondary","fontSize":"text-xs","paddingTop":0,"paddingBottom":3} -->
	<p class="has-font-secondary-color has-text-color has-text-xs-font-size pb__3">Our new WordPress theme</p>
	<!-- /wp:paragraph -->
	<!-- wp:heading {"level":3,"textColor":"font-primary","fontSize":"text-xl","paddingTop":0,"paddingBottom":5,"paddingLeft":0,"paddingRight":0} -->
	<h3 class="has-font-primary-color has-text-color has-text-xl-font-size pb__5">Build a shiny new website</h3>
	<!-- /wp:heading -->
	<!-- wp:ainoblocks/multiple-buttons -->
<div class="wp-block-ainoblocks-multiple-buttons"><!-- wp:ainoblocks/button {"size":"size__s","borderRadius":200,"label":"Get started","backgroundColor":"primary","textColor":"button-color-primary","className":"is-style-primary"} -->
<div class="wp-block-ainoblocks-button is-style-primary has-button-color-primary-color has-primary-background-color has-text-color has-background" style="border-radius:200px"><a class="wp-block-ainoblocks-button__link size__s 200" href="https://ainoblocks.io/" style="border-radius:200px">Get started</a></div>
