...
return array(
	...
	<div class="wp-block-ainoblocks-grid-item col_start_d__1 col_end_d__4 col_start_t__1 col_end_t__13 col_start_m__1 col_end_m__13 align-self__start justify-self__stretch no-stacking mb_d__0 mb_t__11 mb_m__10"><!-- wp:heading {"textColor":"variant-font-primary","fontSize":"text-l"} -->
	<h2 class="has-variant-font-primary-color has-text-color has-text-l-font-size">Who we are</h2>
	<!-- /wp:heading --></div>
	...
	<p class="has-variant-font-tertiary-color has-text-color has-text-xs-font-size pt__4">Art Director</p>
	<!-- /wp:paragraph -->
	
	<!-- wp:paragraph {"textColor":"variant-font-secondary","fontSize":"text-xs","paddingTop":7} -->
	<p class="has-variant-font-secondary-color has-text-color has-text-xs-font-size pt__7">Lisa a a the head of our art department. She is responsible for the coordination of the entire team and and a great coworker to talk to. She is fun, easy going and loves dogs, hiking and outdoor adventures.</p>
	<!-- /wp:paragraph --></div>
	...
	<!-- wp:paragraph {"textColor":"variant-font-tertiary","fontSize":"text-xs","paddingTop":4} -->
	<p class="has-variant-font-tertiary-color has-text-color has-text-xs-font-size pt__4">Marketing Assistant</p>
	<!-- /wp:paragraph -->
	...
	<!-- wp:paragraph {"textColor":"variant-font-tertiary","fontSize":"text-xs","paddingTop":4} -->
	<p class="has-variant-font-tertiary-color has-text-color has-text-xs-font-size pt__4">Frontend Developer</p>
	<!-- /wp:paragraph -->
	
	<!-- wp:paragraph {"textColor":"variant-font-secondary","fontSize":"text-xs","paddingTop":7} -->
	<p class="has-variant-font-secondary-color has-text-color has-text-xs-font-size pt__7">If you need help with tech, Jon will be your guy. He is calm and a coffee lover, so if you like coffee you will have something in common with Jon. He is our code guy and we all love him for this.</p>
	<!-- /wp:paragraph --></div>
	<!-- /wp:ainoblocks/grid-item --></div></div>
