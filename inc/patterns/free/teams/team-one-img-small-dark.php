...
return array(
	'title'      => __( 'One small team image, heading and intro text (Dark)', 'aino' ),
	...
	<div class="wp-block-ainoblocks-grid-item col_start_d__1 col_end_d__6 col_start_t__1 col_end_t__6 col_start_m__1 col_end_m__13 align-self__start justify-self__start no-stacking mb_t__0 mb_m__7"><!-- wp:heading {"level":2,"textColor":"variant-font-primary","fontSize":"text-5-xl"} -->
	<h2 class="has-variant-font-primary-color has-text-color has-text-5-xl-font-size">Our story</h2>
	<!-- /wp:heading --></div>
	...
	<div class="wp-block-ainoblocks-grid-item col_start_d__6 col_end_d__13 col_start_t__6 col_end_t__13 col_start_m__1 col_end_m__13 align-self__start justify-self__start no-stacking"><!-- wp:paragraph {"textColor":"variant-font-secondary","fontSize":"text-m","paddingBottom":11} -->
	...
	<figure class="wp-block-image size-full"><img src="' . get_stylesheet_directory_uri() . '/assets/images/pattern-lib/free/team-one-img-small-dark.jpg" alt=""/></figure>
	<!-- /wp:image --></div>
