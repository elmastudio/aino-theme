...
return array(
	...
	<div class="wp-block-ainoblocks-grid-item col_start_d__1 col_end_d__4 col_start_t__1 col_end_t__13 col_start_m__1 col_end_m__13 align-self__start justify-self__stretch no-stacking mb_t__11 mb_m__0 two-col-grid-tablet"><!-- wp:heading {"textColor":"button-color-secondary","fontSize":"text-l","paddingBottom":7} -->
	<h2 class="has-button-color-secondary-color has-text-color has-text-l-font-size pb__7">Packaging Design</h2>
	<!-- /wp:heading -->
