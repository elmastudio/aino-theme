<?php
/**
 * 3-column post grid with small heading (Dark)
 */
...
return array(
	...
	<div class="wp-block-ainoblocks-grid-item col_start_d__1 col_end_d__13 col_start_t__1 col_end_t__13 col_start_m__1 col_end_m__13 align-self__start justify-self__start no-stacking mb_m__0"><!-- wp:heading {"textColor":"background-primary","fontSize":"text-xl","paddingBottom":13} -->
	<h2 class="has-background-primary-color has-text-color has-text-xl-font-size pb__13">From the blog</h2>
	<!-- /wp:heading --></div>
	...
	<!-- wp:post-title {"isLink":true,"style":{"elements":{"link":{"color":{"text":"var:preset|color|variant-font-primary"}}}},"textColor":"variant-font-primary","fontSize":"text-l"} /-->
	
	<!-- wp:post-excerpt {"textColor":"variant-font-secondary","fontSize":"text-xs"} /-->
	
	<!-- wp:post-terms {"term":"category","style":{"typography":{"lineHeight":"1.2"}},"textColor":"variant-font-secondary","fontSize":"text-xs"} /-->
