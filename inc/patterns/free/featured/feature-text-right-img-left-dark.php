...
return array(
	...
	<!-- wp:heading {"textColor":"variant-font-primary","fontSize":"text-5xl"} -->
	...
	<figure class="wp-block-image size-full"><img src="' . get_stylesheet_directory_uri() . '/assets/images/pattern-lib/free/feature-03-dark.jpg" alt=""/></figure>
	<!-- /wp:image --></div>
