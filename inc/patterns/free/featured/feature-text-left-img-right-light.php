<?php
/**
 * Text content left, image right aligned. (Light version)

 */

return array(
	'title'      => __( 'Left-aligned content with right-aligned image. (Light)', 'aino' ),
	...
	<div class="wp-block-ainoblocks-grid-item col_start_d__2 col_end_d__6 col_start_t__1 col_end_t__6 col_start_m__1 col_end_m__13 align-self__center justify-self__start no-stacking mt_d__0 mt_m__0 mb_d__0 mb_m__0"><!-- wp:paragraph {"textColor":"font-tertiary","fontSize":"text-m","paddingTop":0,"paddingBottom":3} -->
	...
	<figure class="wp-block-image size-full"><img src="' . get_stylesheet_directory_uri() . '/assets/images/pattern-lib/free/feature-02.jpg" alt=""/></figure>
	<!-- /wp:image --></div>
	<!-- /wp:ainoblocks/grid-item -->
