...
return array(
	...
	<div class="wp-block-ainoblocks-grid-item col_start_d__2 col_end_d__6 col_start_t__1 col_end_t__7 col_start_m__1 col_end_m__13 align-self__start justify-self__start no-stacking mt_d__0 mt_m__0 mb_d__0 mb_m__9"><!-- wp:heading {"textColor":"font-primary","fontSize":"text-5xl"} -->
	...
	<figure class="wp-block-image size-large pt__14"><img src="' . get_stylesheet_directory_uri() . '/assets/images/pattern-lib/free/feature-01.jpg" alt=""/></figure>
	<!-- /wp:image --></div>
