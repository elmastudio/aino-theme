...
return array(
	...
	'inserter' => false,
	'content'  => '<!-- wp:heading {"level":1,"textAlign":"center","textColor":"font-primary","fontSize":"text-3xl","paddingBottom":6} --><h1 class="has-text-align-center pb__6 has-font-primary-color has-text-color has-text-3-xl-font-size">' . esc_html( _x( '404 Error', 'Error code for a webpage that is not found.', 'aino' ) ) . '</h1><!-- /wp:heading -->
