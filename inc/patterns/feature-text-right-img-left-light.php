...
return array(
	...
	<!-- /wp:separator --></div>
	<!-- /wp:ainoblocks/grid-item --><!-- wp:ainoblocks/grid-item {"gridColumnStartDesktop":8,"gridColumnEndDesktop":12,"gridColumnStartTablet":8,"gridColumnEndTablet":13,"gridColumnStartMobile":1,"gridColumnEndMobile":13,"alignItem":"center","marginTopDesktop":0,"marginBottomDesktop":0,"marginTopMobile":0,"marginBottomMobile":0} -->
	<div class="wp-block-ainoblocks-grid-item col_start_d__8 col_end_d__12 col_start_t__8 col_end_t__13 col_start_m__1 col_end_m__13 align-self__center justify-self__start no-stacking mt_d__0 mt_m__0 mb_d__0 mb_m__0"><!-- wp:paragraph {"textColor":"font-tertiary","fontSize":"s","paddingTop":0,"paddingBottom":3} -->
	...
	<figure class="wp-block-image size-full"><img src="' . get_stylesheet_directory_uri() . '/assets/images/pattern-lib/feature-03.jpg" alt=""/></figure>
	<!-- /wp:image --></div>
	<!-- /wp:ainoblocks/grid-item -->
