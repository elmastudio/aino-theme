<?php
/**
 * Team One Member large (Dark version)
 *
 * @package aino
 */
...
return array(
	...
	<div class="wp-block-ainoblocks-grid-item col_start_d__2 col_end_d__12 col_start_t__1 col_end_t__13 col_start_m__1 col_end_m__13 align-self__start justify-self__start no-stacking mb_t__0 mb_m__0"><!-- wp:heading {"level":2,"textColor":"variant-font-primary","fontSize":"xl","paddingBottom":13} -->
	...
	<div class="wp-block-ainoblocks-grid-item col_start_d__6 col_end_d__11 col_start_t__5 col_end_t__12 col_start_m__1 col_end_m__13 align-self__start justify-self__start no-stacking"><!-- wp:paragraph {"textColor":"variant-font-secondary","fontSize":"m","paddingBottom":7} -->
	...
	<p class="has-variant-font-secondary-color has-text-color has-m-font-size">Each one of our team member brings their unique strength and knowledge with them. Combining them makes us a wonderful diverse team.</p>
	<!-- /wp:paragraph --></div>
