...
return array(
	...
	<!-- wp:paragraph {"textColor":"font-secondary","fontSize":"s","paddingTop":0} -->
	<p class="has-font-secondary-color has-text-color has-s-font-size">We had the pleasure to design the new packaging of Wallis cookies, a famous New Zealand vegan dog cookies brand.</p>
	<!-- /wp:paragraph --></div>
