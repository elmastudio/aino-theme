...
return array(
	...
	<div class="wp-block-ainoblocks-flex-item auto pt__9 pb__9 pl__8 pr__8" style="flex-grow:2"><!-- wp:paragraph {"textColor":"font-secondary","fontSize":"s","paddingTop":0,"paddingBottom":3} -->
	<p class="has-font-secondary-color has-text-color has-s-font-size pb__3">Our new WordPress theme</p>
	<!-- /wp:paragraph -->
	...
	<div class="wp-block-ainoblocks-button has-button-color-primary-color has-primary-background-color has-text-color has-background" style="border-radius:200px"><a class="wp-block-ainoblocks-button__link size__s 200" href="https://wpaino.com/" style="border-radius:200px">Get started</a></div>
	...
	<div class="wp-block-image"><figure class="aligncenter size-full is-resized"><img src="' . get_stylesheet_directory_uri() . '/assets/images/pattern-lib/banner-default-light.png" alt="" width="266" height="266"/></figure></div>
	<!-- /wp:image --></div>
