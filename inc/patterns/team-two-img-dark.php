...
return array(
	...
	<figure class="wp-block-image size-full br-all__xs"><img src="' . get_stylesheet_directory_uri() . '/assets/images/pattern-lib/team-two-img-01-dark.jpg" alt=""/></figure>
	<!-- /wp:image -->
	...
	<figure class="wp-block-image size-full br-all__xs"><img src="' . get_stylesheet_directory_uri() . '/assets/images/pattern-lib/team-two-img-02-dark.jpg" alt=""/></figure>
	<!-- /wp:image -->
