...
return array(
	...
	<div class="wp-block-ainoblocks-grid-item col_start_d__2 col_end_d__6 col_start_t__1 col_end_t__7 col_start_m__1 col_end_m__13 align-self__start justify-self__start no-stacking mt_d__0 mt_m__0 mb_d__0 mb_m__9"><!-- wp:heading {"textColor":"variant-font-primary","fontSize":"m"} -->
	...
	<div class="wp-block-ainoblocks-grid-item col_start_d__8 col_end_d__12 col_start_t__7 col_end_t__13 col_start_m__1 col_end_m__13 align-self__start justify-self__start no-stacking mt_d__0 mb_d__0 mb_m__0"><!-- wp:heading {"level":3,"textColor":"variant-font-primary","fontSize":"xxs","paddingBottom":4} -->
	...
	<div class="wp-block-ainoblocks-grid-item col_start_d__2 col_end_d__12 col_start_t__1 col_end_t__13 col_start_m__1 col_end_m__13 align-self__start justify-self__start no-stacking mt_d__0 mb_d__0 mb_m__0"><!-- wp:image {"sizeSlug":"full","linkDestination":"none","borderRadius":"xs","paddingTop":14} -->
	<figure class="wp-block-image size-full pt__14 br-all__xs"><img src="' . get_stylesheet_directory_uri() . '/assets/images/pattern-lib/feature-01-dark.jpg" alt=""/></figure>
	<!-- /wp:image --></div>
